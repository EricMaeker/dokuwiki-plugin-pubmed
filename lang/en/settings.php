...
$lang['user_defined_output'] = 'Tokened user output. Eg: %authors%. %title%. %iso%. See plugin README.md file for details.';
...
$lang['twitter_via_user_name'] = "Twitter user name (without @ char) for Tweet Urls creation (via @UserName)";
